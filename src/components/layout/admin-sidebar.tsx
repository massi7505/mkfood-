    ...
    <Sidebar collapsible='icon' className='border-zinc-800'>
      <SidebarHeader className='border-b border-zinc-800 bg-zinc-950 text-white'>
        <Link className='flex items-center gap-3 px-2 py-3' href='/admin'>
          <span className='flex size-9 items-center justify-center rounded-md bg-white text-xs font-bold text-zinc-950'>
            ADM
          </span>
          <span className='group-data-[collapsible=icon]:hidden'>
            <span className='block max-w-40 truncate text-sm font-semibold'>Administration</span>
